...
void CPropertiesWnd::InitPropList()
{
	...
	_tcscpy_s(lf.lfFaceName, _T("Arial, 新細明體"));
	...
	CMFCPropertyGridColorProperty* pColorProp = new CMFCPropertyGridColorProperty(_T("視窗色彩"), RGB(210, 192, 254), nullptr, _T("指定預設的視窗色彩"));
	...
	pGroup411->AddSubItem(new CMFCPropertyGridProperty(_T("項目 1"), (_variant_t) _T("值 1"), _T("這是說明")));
	pGroup411->AddSubItem(new CMFCPropertyGridProperty(_T("項目 2"), (_variant_t) _T("值 2"), _T("這是說明")));
	pGroup411->AddSubItem(new CMFCPropertyGridProperty(_T("項目 3"), (_variant_t) _T("值 3"), _T("這是說明")));
